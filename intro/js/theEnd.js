//delcaling variables: This page is the same and index.html but with funtion adjustments
let mountain;
let mountainFront;
let sky;
let sunset;
...
//animation mapping for table of contents 
...
//frame based animation functions
function draw(){
    noTint();
    image(sky,0,0);
